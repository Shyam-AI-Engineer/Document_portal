...
class ConversationalRAG:
    def__init__(self.session_id: str, retriever):
        try:
            ...
            raise DocumentPortalException("Failed tp load LLM", sys)
    ...
    def load_retriever_from_faiss(self,index_path: str):
        try:
            ...
            self.log.info("Loaded tetriever from FAISS index", index_path=index_path)
